        ...
        <div>
            <h1 className="title">ELO DOG</h1>
                <div className="Box"> 
                    ...
                    <ul>
                        <li className="list">Ter um cachorro em casa fará bem tanto para você quanto para ele.</li>
                        <li className="list">Você se sentira mais motivado em sair para caminhar se sempre tiver um companheiro para isso.</li>
                        <li className="list">Como os pets de rua estão vulneráveis a diversos tipos de maus-tratos, ao adotar, você estará garantindo uma melhor qualidade de vida à ele.</li>
                        <li className="list">Muito companheiros!Já ouviu a frase: “O cão é o melhor amigo do homem” , realmente, é real! </li>
                    </ul>
                    </div>
